...
enum Keccak256OneBlockKernel {
    static func spec(forInputLength inputLength: Int) -> KernelSpec {
        KernelSpec(
            kernel: "keccak_256_oneblock_specialized",
            family: .scalar,
            queueMode: .metal3,
...
public final class Keccak256BatchHasher: @unchecked Sendable {
    ...
    public func makeFixedOneBlockPlan(descriptor: FixedMessageBatchDescriptor) throws -> Keccak256FixedOneBlockHashPlan {
        try Keccak256FixedOneBlockHashPlan(context: context, descriptor: descriptor)
    }
...
public final class Keccak256FixedOneBlockHashPlan: @unchecked Sendable {
    ...
    init(context: MetalContext, descriptor: FixedMessageBatchDescriptor) throws {
        ...
        self.pipeline = try context.pipeline(for: Keccak256OneBlockKernel.spec(forInputLength: descriptor.messageLength))
