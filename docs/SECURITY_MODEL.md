...
- `M31SumcheckVerificationReportV1` classifies that verifier result as only a `revealedEvaluationVectorFoldingTrace`; full multilinear sum-check, AIR-constraint sum-check, and zero-knowledge AIR sum-check scopes remain false,
